...
// Type-safe wrappers for the generic fixtures
function createBeach(overrides: Partial<Beach> = {}): Beach {
  return createBeachFixture(overrides) as unknown as Beach;
}

function createForecast(overrides: Partial<EnhancedForecastEntity> = {}): EnhancedForecastEntity {
  return createForecastFixture(overrides) as unknown as EnhancedForecastEntity;
}
