...
import type { WeekScoutResponse, WeekScoutWindowResponse } from '@/lib/services/discovery/week-scout';
...
function forecast(windows: WeekScoutWindowResponse[]): WeekScoutResponse {
  return {
