...
describe("getNormalizedTimeString", () => {
  ...
  it("returns 00:00:00 for midnight to 2:59 UTC", () => {
    expect(getNormalizedTimeString(new Date("2024-07-15T00:00:00Z"))).toBe("00:00:00");
    expect(getNormalizedTimeString(new Date("2024-07-15T02:59:00Z"))).toBe("00:00:00");
  });

  it("returns 03:00:00 for 3:00 to 5:59 UTC", () => {
    expect(getNormalizedTimeString(new Date("2024-07-15T03:00:00Z"))).toBe("03:00:00");
    expect(getNormalizedTimeString(new Date("2024-07-15T05:59:00Z"))).toBe("03:00:00");
  });

  it("returns 21:00:00 for 21:00 to 23:59 UTC", () => {
    expect(getNormalizedTimeString(new Date("2024-07-15T21:00:00Z"))).toBe("21:00:00");
    expect(getNormalizedTimeString(new Date("2024-07-15T23:59:00Z"))).toBe("21:00:00");
  });
});
