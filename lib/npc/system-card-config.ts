const PERSONA_POSTING_FLAG = "NPC_PERSONA_POSTING_ENABLED";
const SYSTEM_CARDS_FLAG = "QUIVER_SYSTEM_CARDS_ENABLED";
const LEGACY_MORNING_FORECAST_FLAG = "QUIVER_LEGACY_MORNING_FORECAST_ENABLED";
...
const SYSTEM_CARD_DEDUPE_DAYS = 14;
const SYSTEM_CARD_SEMANTIC_DEDUPE_DAYS = 7;
