...
export const IOS_APP_STORE_SMART_BANNER_ARGUMENT = `https://go.quiversurf.app/app?source=ios_smart_app_banner&surface=web&placement=apple_smart_banner&utm_source=ios_safari&utm_medium=smart_banner&utm_campaign=${APP_FIRST_CAMPAIGN}`;
