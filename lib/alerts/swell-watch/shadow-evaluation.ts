...
interface ShadowEvaluation {
  ...
  derivation: Awaited<ReturnType<typeof ingestAttestedSwellWatchCohort>>["derivation"];
...
export async function evaluateSwellWatchShadow(
  ...
  const result: ShadowEvaluation = {
    ...
    status: "suppressed", reason: null, scopeOutcomes: null, derivation: null, suppressionReasons: {}, candidateCount: null, stableRegionalEventCount: null,
