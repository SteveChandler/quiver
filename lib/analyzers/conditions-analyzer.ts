 ...
 *
 * Used by the Morning Intel pipeline (`analyzeConditions`,
 * `getConservativeRecommendation`). The numeric scoring API has been
 * replaced by the domain-driven scoring engine (`@/lib/domains/scoring`).
 *
