...
export const QUIVER_STICKER_ASSETS = {
  ...
  halftoneCircle: {
    slug: "halftone-circle",
    src: "/images/quiver-stickers/halftone-circle.png",
    alt: "Halftone circle texture",
    width: 201,
    height: 204,
  },
  blackBrushScrap: {
    slug: "black-brush-scrap",
    src: "/images/quiver-stickers/black-brush-scrap.png",
    alt: "Brush scrap texture",
    width: 178,
    height: 216,
  },
  orangeMap: {
  ...
  navyLightning: {
    slug: "navy-lightning",
    src: "/images/quiver-stickers/navy-lightning.png",
    alt: "Lightning sticker",
    width: 160,
    height: 83,
  },
  tealCurvedArrow: {
    slug: "teal-curved-arrow",
    src: "/images/quiver-stickers/teal-curved-arrow.png",
    alt: "Curved arrow sticker",
    width: 126,
    height: 124,
  },
  spotSwellMatch: {
  ...
  forecastWaveMark: {
    slug: "forecast-wave-mark",
    src: "/images/quiver-stickers/forecast-wave-mark.png",
    alt: "90s forecast wave sticker",
    width: 512,
    height: 512,
  },
  blogClearerCall: {
    slug: "blog-clearer-call",
    src: "/images/quiver-stickers/blog-clearer-call.png",
    alt: "Clearer surf call zine sticker",
    width: 512,
    height: 512,
  },
  blogDawnPatrol: {
    slug: "blog-dawn-patrol",
    src: "/images/quiver-stickers/blog-dawn-patrol.png",
    alt: "Dawn patrol planning zine sticker",
    width: 512,
    height: 512,
  },
  blogSessionLog: {
    slug: "blog-session-log",
    src: "/images/quiver-stickers/blog-session-log.png",
    alt: "Session log signal zine sticker",
    width: 512,
    height: 512,
  },
  spotWindRead: {
  ...
  goldTape: {
    slug: "gold-tape",
    src: "/images/quiver-stickers/gold-tape.png",
    alt: "Gold tape sticker",
    width: 379,
    height: 86,
  },
  tealTape: {
    slug: "teal-tape",
    src: "/images/quiver-stickers/teal-tape.png",
    alt: "Teal tape sticker",
    width: 401,
    height: 89,
  },
  creamTornStrip: {
    slug: "cream-torn-strip",
    src: "/images/quiver-stickers/cream-torn-strip.png",
    alt: "Cream torn paper strip",
    width: 325,
    height: 149,
  },
  creamCoastMap: {
