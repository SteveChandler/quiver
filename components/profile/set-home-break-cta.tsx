    ...
    <div className="bg-gradient-to-r from-[#F78E42]/10 to-[#F78E42]/5 border border-[#F78E42]/30 rounded-2xl p-4 sm:p-5 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          onClick={handleClick}
          disabled={isLoading}
          className="flex-shrink-0 px-4 py-2 rounded-full bg-ocean-blue text-white text-sm font-semibold hover:bg-ocean-blue/90 transition-colors disabled:opacity-50"
