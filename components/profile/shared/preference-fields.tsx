...
/**
 * Preferred Wave Size Field - Dropdown with emoji + description
 */
export interface PreferredWaveSizeFieldProps extends BaseFieldProps {
  label?: string;
  description?: string;
}

export function PreferredWaveSizeField({
  control,
  name,
  error,
  disabled = false,
  label = "Preferred Wave Size",
  description = "What wave size do you prefer surfing?",
}: PreferredWaveSizeFieldProps) {
  return (
    <Controller
      control={control}
      name={name}
...
/**
 * Preferred Break Type Field - Dropdown with emoji + description
 */
export interface PreferredBreakTypeFieldProps extends BaseFieldProps {
  label?: string;
  description?: string;
}

export function PreferredBreakTypeField({
  control,
  name,
  error,
  disabled = false,
  label = "Preferred Break Type",
  description = "What type of break do you prefer?",
}: PreferredBreakTypeFieldProps) {
  return (
    <Controller
      control={control}
      name={name}
...
/**
 * Crowd Preference Field - Dropdown with emoji + description
 */
export interface CrowdPreferenceFieldProps extends BaseFieldProps {
  label?: string;
  description?: string;
}

export function CrowdPreferenceField({
  control,
  name,
  error,
  disabled = false,
  label = "Crowd Preference",
  description = "How do you feel about crowds at the beach?",
}: CrowdPreferenceFieldProps) {
  return (
    <Controller
      control={control}
      name={name}
