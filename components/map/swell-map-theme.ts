...
export type SwellLayerId = "s1" | "s2" | "ww" | "wind" | "tide";
export const SWELL_LAYER_ORDER: readonly SwellLayerId[] = ["s1", "s2", "ww", "wind", "tide"];
export type SwellLayerAvailability = Record<SwellLayerId, boolean>;
