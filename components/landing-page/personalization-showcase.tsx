      ...
      {!user && (
        <div className="mt-8 flex flex-col items-center gap-2">
          <button
            ...
            className="rounded-full bg-ocean-blue px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-ocean-blue/90 active:scale-95 transition-[background-color,transform] duration-150"
          >
            See Your Forecast
          </button>
