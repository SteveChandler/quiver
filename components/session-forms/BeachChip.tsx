      ...
      >
        ...
        <div className="mt-3 flex gap-2">
          <button
            ...
            className="flex-1 rounded-lg bg-[#F78E42] py-2.5 text-sm font-semibold text-white active:scale-[0.96] transition-[background-color,transform] duration-150 hover:bg-[#E07D35] shadow-sm shadow-[#F78E42]/20"
          >
            Yeah
          </button>
          <button
