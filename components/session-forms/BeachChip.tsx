      ...
      >
        ...
        <div className="mt-3 flex gap-2">
          <button
            ...
            className="flex-1 rounded-lg bg-ocean-blue py-2.5 text-sm font-semibold text-white active:scale-[0.96] transition-all duration-150 hover:bg-ocean-blue/90 shadow-sm shadow-ocean-blue/20"
          >
            Yeah
          </button>
          <button
            type="button"
            onClick={onChange}
            className="flex-1 rounded-lg border border-[#404C92] py-2.5 text-sm font-semibold text-[#9AABC6] hover:text-[#F0F0F0] hover:border-[#9AABC6]/40 active:scale-[0.96] transition-all duration-150"
          >
            Nah, different spot
          </button>
        </div>
