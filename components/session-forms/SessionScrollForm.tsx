...
export function SessionScrollForm({
  ...
  return (
    <div className={cn("flex flex-col min-h-screen bg-white", className)}>
      {/* Sticky header */}
      <header className="sticky top-0 z-20 flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100">
        <button
          type="button"
          aria-label="Cancel"
          onClick={onCancel}
        ...
        <Button
          ...
          onClick={handleSave}
          className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-4 disabled:opacity-40"
        >
