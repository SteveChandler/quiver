        ...
        <div className="flex flex-wrap gap-2">
          {availableStates.slice(0, 8).map((state) => (
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-[#252D6B] border border-[#F78E42]/30 text-sm text-white hover:border-[#F78E42] hover:bg-[#F78E42]/10 transition-all focus-ring"
            >
              {state.stateName}
            </button>
          ))}
          {availableStates.length > 8 && (
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/20 text-sm text-slate-300 hover:bg-white/10 transition-all focus-ring"
            >
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {selected.length < 3 && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-white/5 border border-white/20 text-sm text-slate-300 hover:bg-white/10 transition-all focus-ring"
          >
          ...
          <div className="flex flex-wrap gap-2">
            {unselectedStates.map((state) => (
              <button
                ...
                type="button"
                onClick={() => addState(state.stateSlug)}
                className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/20 text-sm text-white hover:border-[#F78E42] hover:bg-[#F78E42]/10 transition-all focus-ring"
              >
                {state.stateName}
              </button>
            ))}
