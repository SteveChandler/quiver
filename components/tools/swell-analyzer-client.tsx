  ...
  return (
    <div className="min-h-screen" style={{ background: "#0F1535" }}>
        ...
        <div className="container mx-auto max-w-4xl px-4 py-10 sm:py-14">
          <div className="text-center mb-2">
            ...
            <p className="text-[#B8C7E0] text-base sm:text-lg max-w-xl mx-auto">
              Understand how swell period and direction affect wave quality — then check
              if your break is in the sweet spot.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8 space-y-6">
        ...
        >
          <h2 className="font-heading text-lg font-bold text-white">
            Groundswell vs windswell explained
          </h2>

          <div className="grid gap-4 sm:grid-cols-2">
            <div
              className="rounded-xl border p-4"
              style={{ background: "rgba(64,76,146,0.2)", borderColor: "rgba(64,76,146,0.4)" }}
            >
              <div className="font-mono text-xs font-semibold uppercase tracking-widest text-[#F78E42] mb-2">
                Groundswell (12s+)
              </div>
              <p className="text-sm text-[#B8C7E0] leading-relaxed">
                Generated by distant storms. The long travel time organizes energy into
                clean, consistent sets. Waves break powerfully and predictably.
              </p>
            </div>
            <div
              className="rounded-xl border p-4"
            ...
            >
              ...
              <p className="text-sm text-[#B8C7E0] leading-relaxed">
                Created by local winds. Short period means waves are disorganized — often
                choppy, crumbly, or close-out prone.
              </p>
            </div>
          </div>
            ...
            {FAQ.map((item) => (
              <details key={item.q} className="group">
                <summary
                  ...
                  style={{ background: "rgba(64,76,146,0.25)", color: "#B8C7E0" }}
                >
                  {item.q}
...
const FAQ = [
  {
    q: "Is an 8-second swell period good for surfing?",
    a: "An 8-second period is on the borderline. You'll get rideable waves but they'll lack the power and shape of longer-period swells. For most breaks, 10s+ starts to feel significantly better — 12s+ is where things get exciting.",
  },
  {
    q: "What's considered a good swell period?",
    a: "Under 8s = wind swell (choppy). 8–11s = mid-period (decent). 12–15s = groundswell (good). 16s+ = long-period groundswell (powerful). Beach breaks can be fun at 8s while reef breaks need 12s+ to fire.",
  },
  {
    q: "Why does swell direction matter?",
    a: "Every beach has a geographic orientation that determines which swell directions it receives. A beach facing northwest only fires on northwest swells — south swells may be blocked by a headland or arrive at a bad angle causing closeouts.",
  },
  {
    q: "What does a swell window mean?",
    a: "A swell window is the range of directions that produce the best waves at a specific break. Quiver maps the swell window for each beach from geographic data.",
  },
  {
    q: "Can I surf in wind swell conditions?",
    a: "Yes — especially for beginners and longboarders. Short-period swells still produce surfable waves, just less powerful and consistent. It's reef breaks and hollow waves that really need long-period groundswell to show their best.",
  },
];
