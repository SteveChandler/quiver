          ...
          <div className="torn torn-tb rotate-[-0.35deg] border-2 border-ink bg-[#FBF6E8] p-5 shadow-[5px_6px_0_rgba(17,16,13,0.22)]">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                className="zine-alert-input h-11 w-full rounded-sm border-2 border-ink bg-paper px-3 text-sm text-ink outline-none placeholder:text-[#403A2E]/55 focus:border-q-orange focus:ring-2 focus:ring-q-orange/30"
              />
            </div>
