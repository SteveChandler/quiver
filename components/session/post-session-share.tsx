    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3 w-full mt-2">
          <button
            onClick={onShare}
            className="w-full rounded-2xl bg-ocean-blue px-4 py-4 text-base font-bold text-white transition-colors hover:bg-ocean-blue/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#1A1535]"
          >
            Share Your Session
          </button>
