...
export function BeachPhotoGallery({ beach, className }: BeachPhotoGalleryProps) {
  ...
  const mapUrl = `https://api.mapbox.com/styles/v1/mapbox/outdoors-v12/static/pin-s+0074D9(${beach.longitude},${beach.latitude})/${beach.longitude},${beach.latitude},13,0/600x400@2x?access_token=${process.env.NEXT_PUBLIC_MAPBOX_TOKEN}`;
