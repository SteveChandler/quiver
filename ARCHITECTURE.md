...
- DRY form components
  ...
  - Keep business logic out of UI; follow examples in `docs/DRY_COMPONENT_USAGE.md`.
...
- Components & DRY forms: `components/ARCHITECTURE.md`, `docs/DRY_COMPONENT_USAGE.md`
