    ...
    Tables: {
      ...
      beaches_history: {
        Row: {
          ...
          best_tide_height: number | null
          best_tide_type: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "beaches_history_changed_by_fkey"
            columns: ["changed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      sessions_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "sessions_history_changed_by_fkey"
            columns: ["changed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
