...
export async function GET(_request: NextRequest) {
  try {
    ...
    const [
      ...
      (async () => {
        try {
          return await supabase.rpc("get_most_visited_beach", { user_id: userId });
        } catch (err) {
    ...
    console.error("Error in GET /api/me/profile-page:", error);
    return handleApiError(error, "Failed to load profile page data");
  }
}
