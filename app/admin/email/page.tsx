...
type Dashboard = Record<"due" | "attention" | "offers" | "runs", Record<string, unknown>[]> & { reply_check: Record<string, unknown> | null };
export default function EmailAutomationPage(): React.ReactElement {
  ...
  return <div className="space-y-6 p-6"><h1 className="text-2xl font-semibold">Email lifecycle and rewards</h1>
    ...
    {data && <><p>Reply check: {String(data.reply_check?.status ?? "Not checked")}</p>
