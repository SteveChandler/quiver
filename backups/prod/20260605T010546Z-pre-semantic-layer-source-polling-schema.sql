...
CREATE OR REPLACE FUNCTION "public"."compute_user_match_score_core"("p_user_id" "uuid", "p_beach_id" "uuid", "p_wave_height" "text", "p_wave_period" "text", "p_wind_speed" "text", "p_wind_direction" "text", "p_tide_height" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."compute_user_match_score_core"("p_user_id" "uuid", "p_beach_id" "uuid", "p_wave_height" "text", "p_wave_period" "text", "p_wind_speed" "text", "p_wind_direction" "text", "p_tide_height" "text") OWNER TO "postgres";
...
COMMENT ON FUNCTION "public"."get_beach_observation_station"("p_beach_id" "uuid") IS 'Returns the active wave station used for ML observation matching. Direct mappings are preferred, then IOOS/NDBC-direct spatial fallback within 50km and >= 30 degrees swell overlap. Each tier requires recent positive source observations so stale/no-wave stations are not selected.';
...
CREATE OR REPLACE FUNCTION "public"."repair_strict_session_snapshots"("p_limit" integer DEFAULT 100, "p_apply" boolean DEFAULT false) RETURNS TABLE("session_id" "uuid", "user_id" "uuid", "beach_id" "uuid", "forecast_at" timestamp with time zone, "delta_minutes" numeric, "repaired" boolean)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."repair_strict_session_snapshots"("p_limit" integer, "p_apply" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."strict_session_snapshot_repair_candidates"("p_limit" integer DEFAULT 500) RETURNS TABLE("session_id" "uuid", "user_id" "uuid", "beach_id" "uuid", "custom_spot_id" "uuid", "arrival_time" timestamp with time zone, "forecast_at" timestamp with time zone, "delta_minutes" numeric, "nearest_beach_distance_mi" numeric)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT
...
ALTER FUNCTION "public"."strict_session_snapshot_repair_candidates"("p_limit" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_open_meteo_wind_for_beach"("p_beach_id" "uuid", "p_points" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."update_open_meteo_wind_for_beach"("p_beach_id" "uuid", "p_points" "jsonb") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ndbc_direct_stations" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "last_wave_fetch_at" timestamp with time zone,
    "last_wave_fetch_status" "text",
    "last_wave_observed_at" timestamp with time zone,
    CONSTRAINT "ndbc_direct_stations_last_wave_fetch_status_check" CHECK ((("last_wave_fetch_status" IS NULL) OR ("last_wave_fetch_status" = ANY (ARRAY['ok'::"text", 'no_wave_data'::"text", 'not_found'::"text", 'error'::"text"]))))
);
...
COMMENT ON MATERIALIZED VIEW "public"."observable_beaches" IS 'Beaches with ground truth observation sources for ML training. Four paths: (A) IOOS direct station mapping (24h recency), (B) IOOS spatial proximity 50km with >= 30 degrees swell overlap (48h recency), (C) NDBC direct station mapping, NDBC-exclusive only (24h recency), (D) NDBC direct spatial proximity 50km with >= 30 degrees swell overlap (48h recency). Expanded Jun 2026 from 25km to 50km for mixed-swell sentinel recovery. Refreshed every 2h by /api/cron/ioos-sync?phase=observations.';
...
ALTER TABLE "public"."recommendation_session_contexts" OWNER TO "postgres";
...
CREATE INDEX "idx_ndbc_direct_stations_wave_health" ON "public"."ndbc_direct_stations" USING "btree" ("active", "has_wave_data", "last_wave_observed_at" DESC);
...
REVOKE ALL ON FUNCTION "public"."compute_user_match_score_core"("p_user_id" "uuid", "p_beach_id" "uuid", "p_wave_height" "text", "p_wave_period" "text", "p_wind_speed" "text", "p_wind_direction" "text", "p_tide_height" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."compute_user_match_score_core"("p_user_id" "uuid", "p_beach_id" "uuid", "p_wave_height" "text", "p_wave_period" "text", "p_wind_speed" "text", "p_wind_direction" "text", "p_tide_height" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."repair_strict_session_snapshots"("p_limit" integer, "p_apply" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."repair_strict_session_snapshots"("p_limit" integer, "p_apply" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."repair_strict_session_snapshots"("p_limit" integer, "p_apply" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."repair_strict_session_snapshots"("p_limit" integer, "p_apply" boolean) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."strict_session_snapshot_repair_candidates"("p_limit" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."strict_session_snapshot_repair_candidates"("p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."strict_session_snapshot_repair_candidates"("p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."strict_session_snapshot_repair_candidates"("p_limit" integer) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."update_open_meteo_wind_for_beach"("p_beach_id" "uuid", "p_points" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_open_meteo_wind_for_beach"("p_beach_id" "uuid", "p_points" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."update_open_meteo_wind_for_beach"("p_beach_id" "uuid", "p_points" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_open_meteo_wind_for_beach"("p_beach_id" "uuid", "p_points" "jsonb") TO "service_role";
...
GRANT ALL ON TABLE "public"."observable_beaches" TO "anon";
GRANT ALL ON TABLE "public"."observable_beaches" TO "authenticated";
...
GRANT ALL ON TABLE "public"."recommendation_session_contexts" TO "anon";
GRANT ALL ON TABLE "public"."recommendation_session_contexts" TO "authenticated";
GRANT ALL ON TABLE "public"."recommendation_session_contexts" TO "service_role";
