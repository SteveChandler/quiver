...
-- Fix search_path on update_intel_vote_counts
...
-- Fix search_path on update_intel_report_count
...
-- Fix search_path on get_nearby_intel_posts
...
BEGIN
    ...
    SELECT
        ...
        ip.updated_at,
        (public.ST_Distance(
            public.ST_SetSRID(public.ST_MakePoint(ip.longitude, ip.latitude), 4326)::geography,
