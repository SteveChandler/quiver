-- supabase/migrations/20260425000400_add_roadmap_user_events.sql
--
-- Add 3 new roadmap event types to the user_events CHECK constraint.
-- Strictly additive — preserves every existing event type verbatim from
-- the previous CHECK migration (20260420154937). Apply via MCP
-- supabase__apply_migration on project vawdnbbgawichorsjiwe; local file
-- is for schema_migrations parity. CHECK constraints are runtime-only;
-- no type changes.
