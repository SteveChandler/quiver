-- Add Virginia's public, forecastable Atlantic surf catalog.
...
BEGIN
  ...
  IF imported_count <> 10 OR ready_count <> 10 THEN
    RAISE EXCEPTION 'Virginia surf import validation failed: imported %, ready %', imported_count, ready_count;
  END IF;
END $$;
