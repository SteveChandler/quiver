-- Add 9 missing event_type values discovered via Sentry capture of
-- user_events_event_type_check violations on native app. Silent drop
-- pattern was fixed on 2026-04-19 (analytics.ts Sentry routing); these
-- are the names still in violation as of today.
BEGIN;
