...
-- Backfill of the function body change carried by migration
-- 20260412141345_drop_user_preference_columns.sql, which Supabase
-- migration history never recorded as applied to this project even
-- though the column drops it depends on were carried out via MCP.
-- Without this patch the function errors with
-- 'column preferred_wave_size of relation profiles does not exist'
