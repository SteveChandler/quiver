...
-- Only service role inserts milestones (no INSERT policy needed — service role bypasses RLS).
-- Belt-and-suspenders: restrict to own user_id in case a client-side insert is attempted.
