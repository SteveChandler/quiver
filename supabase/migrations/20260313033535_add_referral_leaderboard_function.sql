-- Referral Leaderboard Function
-- Returns the top N referrers with their display names and referral counts.
-- Uses SECURITY DEFINER so it can aggregate across users despite RLS.
--
-- ROLLBACK INSTRUCTIONS:
--   DROP FUNCTION IF EXISTS public.get_referral_leaderboard(INTEGER);
