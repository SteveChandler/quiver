...
COMMENT ON FUNCTION swell_windows_overlap(NUMERIC, NUMERIC, NUMERIC, NUMERIC) IS
  'Computes the angular overlap (in degrees) between two swell windows on a 0-360 circle. Handles wraparound (e.g. 350-10). Returns 0 for NULL or zero-width inputs.';
