...
-- Add Phase 2 match-feature event_types to the user_events CHECK constraint.
-- Preserves all 89 existing values and appends 6 new match-feature events.
...
ALTER TABLE public.user_events
  ADD CONSTRAINT user_events_event_type_check CHECK (
    event_type = ANY (ARRAY[
      ...
      -- Phase 2 match-feature events (2026-04-21)
