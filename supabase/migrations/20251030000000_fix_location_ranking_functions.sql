-- Migration: Fix Location Ranking Functions - Remove references to non-existent columns
-- Purpose: Drop and recreate functions to remove references to swell_rating and wind_rating
-- Issue: Production database has outdated function referencing b.swell_rating and b.wind_rating
-- Resolution: Explicitly drop and recreate with correct schema
