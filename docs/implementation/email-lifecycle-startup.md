...
3. Prove the actual reply-to mailbox delivers a matching Gmail message and pauses a pending recipient during the lifecycle run. Verify sender authentication and unsubscribe in separately approved internal inbox tests.
