...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking. Spec: `docs/superpowers/specs/2026-06-20-landing-swell-view-spotlight-design.md`.
...
gh pr create --base main --title "feat(landing): Swell View launch spotlight + FREE/PRO feature grid" --body "Implements docs/superpowers/specs/2026-06-20-landing-swell-view-spotlight-design.md. Zine-styled Swell View spotlight + badged feature grid; captured Swell View asset. No pricing/map/hero-copy changes."
```
