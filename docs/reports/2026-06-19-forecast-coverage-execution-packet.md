...
- `docs/reports/2026-06-19-phase0-forecast-accuracy-readiness.md`
...
- `docs/reports/2026-06-18-match-score-heuristic-validation.md`
...
- `docs/reports/2026-06-18-shoaling-apply-gap-preflight.md`
...
- `docs/reports/2026-06-19-terrain-gap-preflight.md`
...
- `package.json`
- `docs/reports/2026-06-18-session-face-height-truth-stream.md`
...
- `docs/reports/2026-06-19-session-acquisition-funnel.md`
...
- Apply `supabase/migrations/20260619173000_add_session_log_conditions_set_event.sql` only after explicit approval with the hash-bound phrase in `docs/reports/2026-06-20-track-b-session-acquisition-event-approval-request.md`.
