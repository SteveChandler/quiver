...
- The hash-bound production approval request is `docs/reports/2026-06-20-track-b-session-acquisition-event-approval-request.md`; approval of that phrase is required before the post-approval apply command below.
