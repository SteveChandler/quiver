-- Fixed PostGIS functions with correct data types
-- Run this in your Supabase SQL editor to fix the API endpoints

-- Function to find nearby buoys (FIXED - using JSONB instead of JSON)
...
-- Function to consolidate buoy conditions (FIXED - using JSONB)
...
-- Test the functions
SELECT 'PostGIS functions fixed successfully!' as status; 