...
4. **GSC Stats**: `test -f /tmp/gsc-venv/bin/python3 || (python3 -m venv /tmp/gsc-venv && /tmp/gsc-venv/bin/pip install -q google-auth google-api-python-client) && /tmp/gsc-venv/bin/python3 /Users/stevenchandler/Desktop/dev/quiver/scripts/gsc-stats.py` (timeout: 60s)
